...
class Site {
  ...
  constructor(initialParams) {
    ...
    this.lastUpdateOfGeneralInformation = params.lastUpdateOfGeneralInformation || undefined;
    this.lastUpdateOfEnergyInformation = params.lastUpdateOfEnergyInformation || undefined;
